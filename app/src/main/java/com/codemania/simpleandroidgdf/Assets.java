...
import com.codemania.framework.animation.Animation;
import com.codemania.framework.animation.Frame;

public class Assets {
    private static SoundPool soundPool;
    public static Bitmap welcome,wel, block, cloud1, cloud2, duck, grass, jump,
